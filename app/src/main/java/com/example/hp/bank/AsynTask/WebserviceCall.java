package com.example.hp.bank.AsynTask;
...
public class WebserviceCall extends AsyncTask<Void,Void,String> {
    ...
    public WebserviceCall(Context context, String URL, String jsonRequestBody, String dialogMessage, boolean showDialog, AsyncResponce delegate){
